...
import * as discountCodeService from '../../services/discount-code/discount-code.service';
import { RequestWithUser } from '../../middleware/auth.middleware';
import { ValidateBody } from './types';

export const validate = async (req: Request, res: Response) => {
  try {
    const { code, email, orderAmount } = req.body as ValidateBody;
